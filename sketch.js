var bg,bgImg;
var player, wizardImg, wizard_shooting;
...
function preload(){
  ...
  wizardImg = loadImage("assets/standing.png")
  wizard_shooting = loadImage("assets/enchanting.png")
...
if(keyDown("UP_ARROW")||touches.length>0){
  ...
  player.changeAnimation(wizardAnimation)
}
...
//release bullets and change the image of wizard to shooting position when space is pressed
if(keyWentDown("space")){
  ...
  player.addImage(wizard_shooting)
  bullets = bullets-1
  explosionSound.play();
}
